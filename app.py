...
def inject_theme(dark: bool):
    ...
    .mikasa-wordmark {{
        font-family: 'Fraunces', serif; font-weight: 600; font-size: 5.4rem;
        letter-spacing: -0.01em; color: {text}; margin: 0; line-height: 1;
    }}
    .mikasa-byline {{
        font-size: 0.78rem; color: {text_muted}; margin: 0.3rem 0 0 0.05rem;
...
def main():
    ...
    with top_l:
        st.markdown(
            ...
            <p class="mikasa-byline">by Kezia</p>
            """,
